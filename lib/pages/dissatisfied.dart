...
import 'package:flutter_application_1/Pages/custom_list_view.dart';
import 'package:flutter_application_1/Pages/Musics.dart';
import 'package:flutter_application_1/Pages/DetailPage.dart';
import 'package:flutter_svg/svg.dart';

class Dissatisfied extends StatefulWidget {
  const Dissatisfied({super.key});

  @override
  State<Dissatisfied> createState() => _DissatisfiedState();
}

class _DissatisfiedState extends State<Dissatisfied> {
  late List musics;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
backgroundColor: Color.fromARGB(255, 3, 47, 76),
      appBar: AppBar(
        title: Center(
          child: Text("Recommended Musics"),
        ),
      ),
        ...
        body: Stack(children: [
          SvgPicture.asset(
            'images/bg_home_border.svg',
            width: MediaQuery.of(context).size.width,
            height: MediaQuery.of(context).size.height,
            alignment: AlignmentDirectional.topStart,
          ),
          SvgPicture.asset(
            'images/bg_moon_home.svg',
            width: MediaQuery.of(context).size.width,
            height: MediaQuery.of(context).size.height,
            alignment: AlignmentDirectional.topStart,
          ),
